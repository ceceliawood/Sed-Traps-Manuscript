#Stratification Start Date Code
...
strat_dates <- calc_strat_dates(density_diff = 0.1, temp_profiles = fcre_temp_profile) |> 
  mutate(start = as_date(start),
         end = as_date(end))
write_csv(strat_dates, 'StratStart2019_2023.csv')
